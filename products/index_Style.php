...
<html lang="en"> <!-- -->
  ...
  <head>
    ...
    <!-- Link tag for CSS -->
    <link type="text/css" rel="stylesheet" href="projectFinal/stylesheets/8ProdGal_Style.css" />
			...
			<ul>
				<li>
					<div class="imageContainer">
						<a href="projectFinal/products/index_Stylel_2D.php">
						<img src="projectFinal/images/001mendez.JPG" alt="Artist Mario Mendez">
						<div class="imageContainerText"><p>2D Art</p>  
						</div>
						</a>
					</div>
				</li>
				<li>
					<div class="imageContainer">
						<a href="projectFinal/products/index_Stylel_3D.php">
						<img src="projectFinal/images/001Miguel_Shirt.JPG" alt="Artist Miguel">
						<div class="imageContainerText"><p>3D Art</p>
						</div>
						</a>
					</div>
				</li>
