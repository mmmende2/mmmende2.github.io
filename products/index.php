...
<html lang="en"> <!-- -->
  ...
  <head>
    ...
    <!-- Link tag for CSS -->
    <link type="text/css" rel="stylesheet" href="projectFinal/stylesheets/2products.css" />
			...
			<ul>
				<li>
					<div class="imageContainer">
						<a href="projectFinal/products/index_ArtisDetail_Mario.php">
						<img src="projectFinal/images/001mendez.JPG" alt="Artist Mario Mendez">
						<div class="imageContainerText"><p>Mario Mendez</p>  
						</div>
						</a>
					</div>
				</li>
				<li>
					<div class="imageContainer">
						...
						<img src="projectFinal/images/001Miguel.JPG" alt="Artist Miguel">
						<div class="imageContainerText"><p>Miguel</p>
						</div>
						</a>
					</div>
				</li>
