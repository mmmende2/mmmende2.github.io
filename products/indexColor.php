...
<html lang="en"> <!-- -->
  ...
  <head>
    ...
    <!-- Link tag for CSS -->
    <link type="text/css" rel="stylesheet" href="projectFinal/stylesheets/8ProdGal_Color.css" />
			...
			<ul>
				<li>
					<div class="imageContainer">
						...
						<div class="imageContainerText"><p>Black & White</p>  
						</div>
						</a>
					</div>
				</li>
				<li>
					<div class="imageContainer">
						...
						<div class="imageContainerText"><p>Color</p>
						</div>
						</a>
					</div>
				</li>
