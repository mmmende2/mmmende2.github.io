...
<html lang="en">
  ...
  <body>
	<div id="wrapper"> 
		...
		<form id="quoteform" action="projectFinal/php/confirmRegistration.php" method="post"> <!--took out file path -->
			...
			<p>
				...
				onclick="location.href='http://localhost/CIS425/2161-Spring/projectFinal/register/index.php';"
